...
const BoudHRLandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background font-arabic">
      ...
      <section id="mobile-app" className="py-20 bg-gradient-to-br from-gray-900 via-black to-gray-800 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center space-y-6 mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 backdrop-blur-sm border border-white/10">
              ...
              <span className="text-white text-sm font-medium">تطبيق محمول متقدم</span>
            </div>
            
            <h2 className="text-4xl lg:text-5xl font-bold text-white leading-tight">
              حمّل تطبيق <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">بُعد HR</span>
            </h2>
            ...
            <div className="flex items-center justify-center gap-8 pt-4">
              <div className="text-center">
                ...
                <div className="text-xs text-gray-400">تحميل نشط</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-gray-400">دعم مستمر</div>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-4">
              <div className="grid gap-4">
                <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300">
                  <div className="w-10 h-10 rounded-lg bg-blue-500/20 flex items-center justify-center flex-shrink-0">
                    <MapPin className="w-5 h-5 text-blue-400" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-white text-base mb-1">تسجيل الحضور بـ GPS</h3>
                    <p className="text-gray-300 text-sm">تتبع دقيق للحضور والانصراف باستخدام الموقع الجغرافي</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300">
                  ...
                  <div>
                    <h3 className="font-semibold text-white text-base mb-1">إشعارات ذكية</h3>
                    <p className="text-gray-300 text-sm">تنبيهات فورية ومخصصة لجميع المهام والتحديثات</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300">
                  ...
                  <div>
                    <h3 className="font-semibold text-white text-base mb-1">إدارة الطلبات</h3>
                    <p className="text-gray-300 text-sm">تقديم ومتابعة جميع الطلبات بسهولة ومن أي مكان</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300">
                  ...
                  <div>
                    <h3 className="font-semibold text-white text-base mb-1">دورات تدريبية وتطويرية</h3>
                    <p className="text-gray-300 text-sm">منصة تعلم متكاملة مع دورات تفاعلية ومتابعة التقدم</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300">
                  ...
                  <div>
                    <h3 className="font-semibold text-white text-base mb-1">تقييم الأداء</h3>
                    <p className="text-gray-300 text-sm">نظام تقييم ذكي مع تحليلات مفصلة وخطط التطوير</p>
                  </div>
                </div>
              </div>
              ...
              {/* Download Buttons */}
              <div className="pt-6">
                <h3 className="text-xl font-bold text-white mb-4 text-center">حمّل التطبيق الآن</h3>
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  <Button size="lg" className="bg-white hover:bg-gray-100 text-black font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                    <div className="flex items-center gap-3">
              ...
              <div className="text-center p-4 rounded-xl bg-blue-500/10 border border-blue-500/20 backdrop-blur-sm">
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <span className="font-semibold text-blue-400">قريباً جداً</span>
                </div>
