      ...
      <section className="py-20 bg-gradient-to-br from-primary/5 via-background to-accent/5">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              اكتشف الأسباب التي تجعل بُعد HR الخيار الأمثل لإدارة الموارد البشرية في منظمتك
            </p>
          </div>
                  ...
                  <CardContent className="p-8">
                    <div className="grid lg:grid-cols-2 gap-8 items-center">
                      <div className="space-y-6">
                        ...
                        <p className="text-lg text-muted-foreground leading-relaxed">
                          نقوم بأتمتة جميع العمليات الروتينية في إدارة الموارد البشرية، مما يوفر 70% من الوقت المخصص للمهام الإدارية.
                        </p>
                        
                        <div className="space-y-4">
                          <div className="flex items-center gap-3">
                            <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                            <span className="text-muted-foreground">أتمتة عمليات الرواتب والمزايا بدقة 100%</span>
                          </div>
                          <div className="flex items-center gap-3">
                            <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                            <span className="text-muted-foreground">معالجة طلبات الإجازات والغياب تلقائياً</span>
                          </div>
                          <div className="flex items-center gap-3">
                            <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                            <span className="text-muted-foreground">تقارير ذكية مُحدثة في الوقت الفعلي</span>
                          </div>
                          <div className="flex items-center gap-3">
                            <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                            <span className="text-muted-foreground">تذكيرات ذكية للمواعيد والمهام المهمة</span>
                          </div>
                        </div>
                        ...
                        <div className="bg-primary/5 rounded-lg p-4 border border-primary/10">
                          ...
                          <p className="text-sm text-muted-foreground">
                            توفير 70% من الوقت • تقليل الأخطاء بنسبة 95% • زيادة الإنتاجية بـ 40%
                          </p>
                        </div>
                      </div>
                  ...
                  <CardContent className="p-8">
                    <div className="grid lg:grid-cols-2 gap-8 items-center">
                      <div className="space-y-6">
                        ...
                        <p className="text-lg text-muted-foreground leading-relaxed">
                          نضمن حماية بيانات موظفيك بأعلى معايير الأمان العالمية والمحلية، مع التوافق الكامل مع قوانين حماية البيانات السعودية.
                        </p>
                        
                        <div className="space-y-4">
                          <div className="flex items-center gap-3">
                            <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                            <span className="text-muted-foreground">تشفير متقدم 256-bit للبيانات الحساسة</span>
                          </div>
                          <div className="flex items-center gap-3">
                            <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                            <span className="text-muted-foreground">مصادقة ثنائية العامل لجميع المستخدمين</span>
                          </div>
                          <div className="flex items-center gap-3">
                            <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                            <span className="text-muted-foreground">نسخ احتياطية آمنة كل 15 دقيقة</span>
                          </div>
                          <div className="flex items-center gap-3">
                            <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                            <span className="text-muted-foreground">مراقبة أمنية 24/7 ضد التهديدات</span>
                          </div>
                        </div>
                        ...
                        <div className="bg-primary/5 rounded-lg p-4 border border-primary/10">
                          ...
                          <p className="text-sm text-muted-foreground">
                            ISO 27001 • NCA ECC • GDPR • قانون حماية البيانات السعودي
                          </p>
                        </div>
                      </div>
                  ...
                  <CardContent className="p-8">
                    <div className="grid lg:grid-cols-2 gap-8 items-center">
                      <div className="space-y-6">
                        ...
                        <p className="text-lg text-muted-foreground leading-relaxed">
                          بنية تحتية سحابية متطورة داخل المملكة العربية السعودية، تضمن الأداء العالي والتوافر المستمر لجميع خدماتنا.
                        </p>
                        ...
                        <div className="bg-primary/5 rounded-lg p-4 border border-primary/10">
                          ...
                          <p className="text-sm text-muted-foreground">
                            وصول آمن من الهاتف المحمول • أجهزة الكمبيوتر • الأجهزة اللوحية • في أي وقت
                          </p>
                        </div>
                      </div>
                  ...
                  <CardContent className="p-8">
                    <div className="grid lg:grid-cols-2 gap-8 items-center">
                      <div className="space-y-6">
                        ...
                        <p className="text-lg text-muted-foreground leading-relaxed">
                          نضمن الامتثال الكامل لجميع القوانين واللوائح السعودية والعالمية، مع التحديث المستمر لمواكبة أي تغييرات قانونية.
                        </p>
                        
                        <div className="space-y-4">
                          <div className="flex items-center gap-3">
                            <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                            <span className="text-muted-foreground">توافق كامل مع نظام العمل السعودي الجديد</span>
                          </div>
                          <div className="flex items-center gap-3">
                            <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                            <span className="text-muted-foreground">تكامل مباشر مع منصة قوى والتأمينات الاجتماعية</span>
                          </div>
                          <div className="flex items-center gap-3">
                            <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                            <span className="text-muted-foreground">تطبيق سياسات السعودة والرقم السعودي</span>
                          </div>
                          <div className="flex items-center gap-3">
                            <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                        ...
                        <div className="bg-primary/5 rounded-lg p-4 border border-primary/10">
                          ...
                          <p className="text-sm text-muted-foreground">
                            قوى • التأمينات الاجتماعية • مدد • البنوك السعودية • الزكاة والضريبة
                          </p>
                        </div>
                      </div>
