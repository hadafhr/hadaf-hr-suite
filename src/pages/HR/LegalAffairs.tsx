    ...
    <div className="min-h-screen p-6" style={{ background: '#000000', color: '#ffffff' }}>
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-2" style={{ color: '#ffffff' }}>نظام إدارة الشؤون القانونية الذكي</h1>
          <p style={{ color: '#e8e4e0' }}>منظومة متطورة لإدارة الشؤون القانونية تستخدم الذكاء الاصطناعي لمراجعة العقود وإدارة القضايا مع التقارير الفورية والامتثال</p>
        </div>
