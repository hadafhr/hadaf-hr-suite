      ...
      <footer className="bg-muted py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <BoudLogo variant="full" size="lg" className="mb-4" />
              <p className="text-muted-foreground text-sm">
                {isArabic 
                  ? 'منصة إدارة الموارد البشرية الأكثر تطوراً في السعودية'
                  : 'The most advanced HR management platform in Saudi Arabia'
                }
              </p>
            </div>
          ...
          <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">
              {isArabic 
                ? '© 2024 بُعد. جميع الحقوق محفوظة.'
                : '© 2024 Boud. All rights reserved.'
              }
            </p>
