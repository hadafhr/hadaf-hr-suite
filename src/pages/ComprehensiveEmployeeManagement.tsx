              ...
              <div className="bg-card/95 backdrop-blur-sm rounded-3xl shadow-soft border border-border/20 p-6">
                ...
                <Tabs value={activeEmployeeOpsTab} onValueChange={handleEmployeeOpsTabChange} className="space-y-6">
                  <TabsList className="grid grid-cols-2 md:grid-cols-5 lg:grid-cols-9 gap-2 bg-transparent p-0 h-auto w-full">
                    <TabsTrigger value="attendance" className="group relative flex flex-col items-center justify-center gap-1 px-4 py-4 rounded-xl font-medium text-xs transition-all duration-300 data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#008C6A] data-[state=active]:via-[#009F87] data-[state=active]:to-[#00694F] data-[state=active]:text-white data-[state=active]:shadow-2xl data-[state=active]:shadow-[#008C6A]/20 bg-gray-900/60 backdrop-blur-xl text-white hover:bg-gradient-to-r hover:from-[#008C6A]/20 hover:to-[#00694F]/20 border border-[#008C6A]/30 data-[state=active]:border-[#008C6A]/70 hover:border-[#008C6A]/50 hover:scale-105 hover:shadow-lg hover:shadow-[#008C6A]/10 overflow-hidden">
                      ...
                      {/* Glow effect */}
                      <div className="absolute -inset-1 bg-gradient-to-r from-[#008C6A]/20 via-transparent to-[#008C6A]/20 rounded-xl blur opacity-0 group-hover:opacity-50 transition-opacity duration-300 pointer-events-none"></div>
                    </TabsTrigger>
