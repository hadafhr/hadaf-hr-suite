...
export const AdminConfiguration: React.FC = () => {
  ...
  const ConfigOptionsList = ({ 
    ...
    <Card className="p-6 backdrop-blur-xl bg-background/40 border border-border hover:shadow-2xl hover:shadow-accent/20 transition-all duration-300 animate-fade-in rounded-2xl">
      ...
      <CardContent>
        <div className="space-y-2">
          {options.map((option) => (
            <div key={option.id} className="flex items-center justify-between p-3 border border-border bg-background/20 rounded-lg">
              <div>
    ...
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden font-arabic" dir="rtl">
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-foreground bg-gradient-to-r from-foreground via-muted-foreground to-foreground bg-clip-text text-transparent mb-2">
          ...
          <div className="flex gap-2">
            ...
            <Button className="bg-gradient-to-r from-accent to-accent hover:from-accent/80 hover:to-accent/80 text-accent-foreground">
        ...
        <Tabs defaultValue="dropdown-options" className="w-full">
          <TabsList className="grid w-full grid-cols-4 bg-background/40 border border-border">
            <TabsTrigger value="dropdown-options" className="flex items-center gap-2 text-foreground data-[state=active]:bg-accent data-[state=active]:text-accent-foreground">
              <Database className="h-4 w-4" />
              خيارات القوائم
            </TabsTrigger>
            <TabsTrigger value="company-policies" className="flex items-center gap-2 text-foreground data-[state=active]:bg-accent data-[state=active]:text-accent-foreground">
              <FileText className="h-4 w-4" />
              سياسات الشركة
            </TabsTrigger>
            <TabsTrigger value="system-settings" className="flex items-center gap-2 text-foreground data-[state=active]:bg-accent data-[state=active]:text-accent-foreground">
              <Settings className="h-4 w-4" />
              إعدادات النظام
            </TabsTrigger>
            <TabsTrigger value="ui-customization" className="flex items-center gap-2 text-foreground data-[state=active]:bg-accent data-[state=active]:text-accent-foreground">
