  ...
  return (
    <div className="space-y-6 p-6" dir="rtl">
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold mb-2 text-foreground">الاستدامة والمسؤولية الاجتماعية</h1>
        <p className="text-muted-foreground">نظام شامل لإدارة برامج CSR & ESG والمسؤولية الاجتماعية</p>
      </div>
