...
const ReportGenerator = () => {
  ...
  const [availableFields, setAvailableFields] = useState([
    { id: 'employee_name', label: 'اسم الموظف', checked: false },
    { id: 'department', label: 'القسم', checked: false },
    { id: 'position', label: 'المنصب', checked: false },
    { id: 'salary', label: 'الراتب', checked: false },
    { id: 'attendance', label: 'الحضور', checked: false },
    { id: 'performance', label: 'الأداء', checked: false },
    { id: 'join_date', label: 'تاريخ الانضمام', checked: false },
    { id: 'status', label: 'الحالة', checked: false }
  ]);
  ...
  const handleGenerateReport = async () => {
    ...
    if (selectedFields.length === 0) {
      toast({ title: 'يرجى اختيار حقل واحد على الأقل', variant: 'destructive' });
      return;
    }
    ...
    try {
      ...
      toast({ title: 'تم إنشاء التقرير بنجاح', variant: 'default' });
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) => setReportConfig({...reportConfig, category: value})}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
...
const SmartAnalytics = () => {
  ...
  const performanceData = [
    { name: 'يناير', average: 78, department: 82, individual: 75 },
    { name: 'فبراير', average: 81, department: 85, individual: 78 },
    { name: 'مارس', average: 79, department: 83, individual: 76 },
    { name: 'أبريل', average: 84, department: 87, individual: 82 },
    { name: 'مايو', average: 86, department: 89, individual: 84 },
    { name: 'يونيو', average: 88, department: 91, individual: 86 }
  ];

  const departmentAnalytics = [
    { name: 'التسويق', value: 30, color: '#3b82f6' },
    { name: 'المبيعات', value: 25, color: '#10b981' },
    { name: 'التطوير', value: 20, color: '#f59e0b' },
    { name: 'الموارد البشرية', value: 15, color: '#ef4444' },
    { name: 'المالية', value: 10, color: '#8b5cf6' }
  ];
  ...
  const predictions = [
    { title: 'الأداء المتوقع الشهر القادم', value: '89%', trend: 'up' },
    { title: 'احتمالية الاحتفاظ بالموظفين', value: '92%', trend: 'up' },
    { title: 'الحاجة للتدريب', value: '23 موظف', trend: 'neutral' },
    { title: 'التوظيفات المطلوبة', value: '8 وظائف', trend: 'up' }
  ];
                ...
                <CardContent className="p-4">
                  <div className="text-center">
                    ...
                    <div className={`inline-flex items-center gap-1 mt-2 px-2 py-1 rounded-full text-xs ${
                      ...
                      {prediction.trend === 'up' ? 'متزايد' : 
                       prediction.trend === 'down' ? 'متناقص' : 'مستقر'}
                    </div>
                  </div>
                </CardContent>
              </Card>
...
const ScheduledReports = () => {
  ...
  const handleAddSchedule = () => {
    ...
    toast({ title: 'تم إضافة التقرير المجدول بنجاح', variant: 'default' });
  };
  ...
  const deleteScheduledReport = (reportId: string) => {
    ...
    toast({ title: 'تم حذف التقرير المجدول', variant: 'default' });
  };
