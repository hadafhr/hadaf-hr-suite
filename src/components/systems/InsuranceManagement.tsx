          ...
          <div className="relative z-10">
            ...
            <div className="text-center">
              ...
              <h1 className="text-4xl font-bold text-white mb-2">
                {isRTL ? 'نظام إدارة التأمين والتأمينات الشامل' : 'Comprehensive Insurance Management System'}
              </h1>
              <p className="text-white/90 text-lg max-w-2xl mx-auto">
                {isRTL ? 'إدارة متكاملة للتأمين الصحي والتأمينات الاجتماعية مع التكامل مع المنصات الحكومية' : 'Integrated management of health insurance and social insurance with government platform integration'}
              </p>
            </div>
          </div>
        </div>
