      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-4">
          <div className="w-16 h-16 bg-gradient-to-br from-[#3CB593] to-[#2da574] rounded-3xl flex items-center justify-center shadow-lg relative overflow-hidden group">
            ...
            <MessageSquare className="h-8 w-8 text-white relative z-10 group-hover:scale-110 transition-transform" />
            <div className="absolute -top-1 -right-1 w-5 h-5 bg-yellow-400 rounded-full animate-pulse"></div>
          </div>
          <div>
            <h1 className="text-3xl font-bold text-black">
              نظام المراسلات الإدارية المتطور
            </h1>
            <p className="text-gray-600 text-lg">
              منظومة شاملة لإدارة المراسلات والمذكرات مع أدوات الذكاء الاصطناعي
            </p>
          </div>
        </div>
      </div>
      <div className="flex items-center gap-3">
        ...
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          ...
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              <DialogTitle>إضافة مراسلة أو مذكرة جديدة</DialogTitle>
              <DialogDescription>
                اختر نوع المراسلة واملأ البيانات المطلوبة
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              <Select value={selectedType} onValueChange={(value: 'incoming' | 'outgoing' | 'memo') => setSelectedType(value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="incoming">مراسلة واردة</SelectItem>
                  <SelectItem value="outgoing">مراسلة صادرة</SelectItem>
                  <SelectItem value="memo">مذكرة داخلية</SelectItem>
                </SelectContent>
              </Select>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label>{selectedType === 'incoming' ? 'المرسل' : selectedType === 'outgoing' ? 'المستقبل' : 'العنوان'} *</Label>
                  <Input placeholder={selectedType === 'memo' ? 'عنوان المذكرة' : 'اسم الجهة'} />
                </div>
                <div>
                  <Label>رقم المعاملة التلقائي</Label>
                  <Input 
                    value={generateTransactionNumber(
                      selectedType === 'incoming' ? 'IN' : 
                      selectedType === 'outgoing' ? 'OUT' : 'MEMO'
                    )}
                    disabled
                    className="bg-muted"
                  />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label>الموضوع *</Label>
                  <Input placeholder="موضوع المراسلة" />
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select>
                    <SelectTrigger>
                      <SelectValue placeholder="سيتم التصنيف تلقائياً" />
                    </SelectTrigger>
                    <SelectContent>
              ...
              <div>
                <Label>المحتوى</Label>
                <Textarea placeholder="محتوى المراسلة أو المذكرة" rows={4} />
              </div>
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button onClick={() => {
                  handleSave(selectedType === 'incoming' ? 'المراسلة الواردة' : 
                            selectedType === 'outgoing' ? 'المراسلة الصادرة' : 'المذكرة الداخلية');
