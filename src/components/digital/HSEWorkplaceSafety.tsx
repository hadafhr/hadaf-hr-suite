    ...
    <div className="space-y-6 p-6" dir="rtl">
      <div className="space-y-4">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-2 text-foreground">الصحة والسلامة المهنية (HSE)</h1>
          <p className="text-muted-foreground">نظام متكامل لإدارة الصحة والسلامة في بيئة العمل</p>
        </div>
