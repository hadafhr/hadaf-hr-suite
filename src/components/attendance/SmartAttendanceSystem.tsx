      ...
      <div className="container mx-auto p-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6 relative z-10">
          <TabsList className="grid w-full grid-cols-7 h-auto p-1 bg-card/60 backdrop-blur-xl border border-border shadow-2xl shadow-accent/10 rounded-xl">
            ...
            <TabsTrigger value="checkin" className="flex flex-col gap-1 py-3 text-foreground data-[state=active]:bg-primary data-[state=active]:text-primary-foreground hover:bg-accent/20 transition-all duration-300 rounded-lg">
              <MapPin className="h-4 w-4" />
              <span className="text-xs">GPS</span>
            </TabsTrigger>
            
            <TabsTrigger value="live-tracking" className="flex flex-col gap-1 py-3 text-foreground data-[state=active]:bg-primary data-[state=active]:text-primary-foreground hover:bg-accent/20 transition-all duration-300 rounded-lg">
              <Navigation className="h-4 w-4" />
              <span className="text-xs">التتبع المباشر</span>
            </TabsTrigger>
            
            <TabsTrigger value="devices" className="flex flex-col gap-1 py-3 text-foreground data-[state=active]:bg-primary data-[state=active]:text-primary-foreground hover:bg-accent/20 transition-all duration-300 rounded-lg">
              <Fingerprint className="h-4 w-4" />
              <span className="text-xs">الأجهزة</span>
            </TabsTrigger>
            
            <TabsTrigger value="schedule" className="flex flex-col gap-1 py-3 text-foreground data-[state=active]:bg-primary data-[state=active]:text-primary-foreground hover:bg-accent/20 transition-all duration-300 rounded-lg">
              <Calendar className="h-4 w-4" />
              <span className="text-xs">الجدولة</span>
            </TabsTrigger>
            
            <TabsTrigger value="points-rewards" className="flex flex-col gap-1 py-3 text-foreground data-[state=active]:bg-primary data-[state=active]:text-primary-foreground hover:bg-accent/20 transition-all duration-300 rounded-lg">
              <Star className="h-4 w-4" />
              <span className="text-xs">النقاط والمكافآت</span>
            </TabsTrigger>
            
            <TabsTrigger value="ai-insights" className="flex flex-col gap-1 py-3 text-foreground data-[state=active]:bg-primary data-[state=active]:text-primary-foreground hover:bg-accent/20 transition-all duration-300 rounded-lg">
