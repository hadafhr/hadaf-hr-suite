-- Create additional enum types for Boud EMS (avoiding existing ones)
DO $$ BEGIN
...
-- Companies table
CREATE TABLE IF NOT EXISTS public.boud_companies (
...
-- User roles table for Boud system
...
-- Departments table
CREATE TABLE IF NOT EXISTS public.boud_departments (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    company_id UUID REFERENCES public.boud_companies(id) ON DELETE CASCADE,
...
-- Job positions table
CREATE TABLE IF NOT EXISTS public.boud_job_positions (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    company_id UUID REFERENCES public.boud_companies(id) ON DELETE CASCADE,
...
-- Enhanced employees table for comprehensive HR management
CREATE TABLE IF NOT EXISTS public.boud_employees (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- Job applications table for recruitment
CREATE TABLE IF NOT EXISTS public.boud_job_applications (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    company_id UUID REFERENCES public.boud_companies(id) ON DELETE CASCADE,
    position_id UUID REFERENCES public.boud_job_positions(id),
...
CREATE TABLE IF NOT EXISTS public.boud_attendance (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- Leave requests with comprehensive workflow
CREATE TABLE IF NOT EXISTS public.boud_leave_requests (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    employee_id UUID REFERENCES public.boud_employees(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.boud_performance_evaluations (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    employee_id UUID REFERENCES public.boud_employees(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.boud_training_programs (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    company_id UUID REFERENCES public.boud_companies(id) ON DELETE CASCADE,
...
-- Training enrollments tracking
CREATE TABLE IF NOT EXISTS public.boud_training_enrollments (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    employee_id UUID REFERENCES public.boud_employees(id) ON DELETE CASCADE,
...
-- Saudi Labor Law compliant disciplinary system
CREATE TABLE IF NOT EXISTS public.boud_disciplinary_actions (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    employee_id UUID REFERENCES public.boud_employees(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.boud_payroll_runs (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    company_id UUID REFERENCES public.boud_companies(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS public.boud_payroll_items (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.boud_employee_terminations (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    employee_id UUID REFERENCES public.boud_employees(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_boud_employees_company_id ON public.boud_employees(company_id);
CREATE INDEX IF NOT EXISTS idx_boud_employees_department_id ON public.boud_employees(department_id);
CREATE INDEX IF NOT EXISTS idx_boud_employees_manager_id ON public.boud_employees(manager_id);
CREATE INDEX IF NOT EXISTS idx_boud_employees_user_id ON public.boud_employees(user_id);
CREATE INDEX IF NOT EXISTS idx_boud_attendance_employee_date ON public.boud_attendance(employee_id, attendance_date);
CREATE INDEX IF NOT EXISTS idx_boud_leave_requests_employee ON public.boud_leave_requests(employee_id);
CREATE INDEX IF NOT EXISTS idx_boud_leave_requests_status ON public.boud_leave_requests(status);
CREATE INDEX IF NOT EXISTS idx_boud_payroll_items_payroll_run ON public.boud_payroll_items(payroll_run_id);
CREATE INDEX IF NOT EXISTS idx_boud_performance_evaluations_employee ON public.boud_performance_evaluations(employee_id);
CREATE INDEX IF NOT EXISTS idx_boud_training_enrollments_employee ON public.boud_training_enrollments(employee_id);
CREATE INDEX IF NOT EXISTS idx_boud_disciplinary_actions_employee ON public.boud_disciplinary_actions(employee_id);

-- Create role checking functions for Boud system
