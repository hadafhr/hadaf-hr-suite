-- ====================================
-- إنشاء نظام إدارة المكافآت والحوافز الشامل
-- ====================================
...
-- ====================================
-- إنشاء دالة توليد أرقام المكافآت
-- ====================================
...
(
  (SELECT id FROM boud_employees LIMIT 1),
  (SELECT id FROM incentive_programs WHERE program_code = 'ANN-PERF-2024'),
  'annual_bonus',
  18000.00,
...
(
  (SELECT id FROM boud_employees LIMIT 1),
  (SELECT id FROM incentive_programs WHERE program_code = 'KPI-QUAR-2024'),
  'kpi_achievement',
  9600.00,
...
(
  (SELECT id FROM boud_employees LIMIT 1),
  (SELECT id FROM incentive_programs WHERE program_code = 'ATT-EXC-2024'),
  'attendance_excellence',
  600.00,
