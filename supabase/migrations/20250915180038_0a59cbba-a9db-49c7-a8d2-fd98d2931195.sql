...
('expense', '11111111-eeee-eeee-eeee-111111111111', (SELECT COALESCE(auth.uid(), '00000000-0000-0000-0000-000000000000')), 'inapp', 'تم إضافة مصروف جديد للرواتب', 'unread'),
('update', 'c344450a-cd2c-4c03-9c54-05b0e651a2fb', (SELECT COALESCE(auth.uid(), '00000000-0000-0000-0000-000000000000')), 'inapp', 'تم تحديث ميزانية الرواتب', 'read')
