...
-- Add audit logging trigger for sensitive data changes (not SELECT)
...
AS $$
BEGIN
  -- Log when someone modifies employee records
...
-- Add audit trigger to boud_employees (INSERT, UPDATE, DELETE only)
