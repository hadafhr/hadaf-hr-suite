-- إدراج قوالب الكفاءات الافتراضية مع تصحيح نوع JSONB
...
-- إدراج قوالب الاختبارات الافتراضية
...
SELECT 
  ...
  'اختبار بيركمان',
  'birkman',
  'تقييم شامل للسلوك والاهتمامات والاحتياجات',
  CAST('[
    {
      "category": "interests",
      "questions": [
        {"id": 1, "text": "أفضل العمل في بيئة تنافسية"},
        {"id": 2, "text": "أستمتع بحل المشكلات المعقدة"}
      ]
    },
    {
      "category": "behavior", 
      "questions": [
        {"id": 3, "text": "أتخذ قرارات سريعة في العمل"},
        {"id": 4, "text": "أفضل العمل ضمن فريق"}
      ]
    }
  ]' AS jsonb),
  CAST('{
...
SELECT 
  ...
  'اختبار DISC',
  'disc',
  'تحليل أنماط السلوك والشخصية في العمل',
  CAST('[
    {
      "id": 1,
